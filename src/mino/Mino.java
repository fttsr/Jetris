...
public class Mino {
    ...
    public void updateXY(int direction) {
        ...
        if (!leftCollision && !rightCollision && !bottomCollision) {
            ...
            // We use tempB array to handle the collision
            b[0].x = tempB[0].x;
            b[0].y = tempB[0].y;
            b[1].x = tempB[1].x;
            b[1].y = tempB[1].y;
    ...
    public void getDirection1() {}  // We leave these methods blank and we override them in Mino_*.java
    ...
    public void checkMovementCollision() {
        ...
        // check static block collision (which is already put)
    ...
    public void update() {
        ...
        // Move the Mino
        if (KeyHandler.upPressed) { // Rotation
            switch (direction) {
